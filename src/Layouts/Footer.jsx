      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4>Students</h4>
            <ul>
              <li><a href="#" onClick={(e) => { e.preventDefault(); handleNav('portal'); }}>Student Portal</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); handleNav('programs'); }}>Courses</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); handleNav('events'); }}>Academic Calendar</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); handleNav('admissions'); }}>Exams</a></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Resources</h4>
