...
const handleDownloadReceipt = (application) => {
  ...
  // ---------- Header ----------
  doc.setFillColor(22, 160, 133);                 // #16A085
              ...
              return (
                <tr key={application.id} className={styles.tableRow}>
                  <td className={styles.nameCell}>
                    <div className={styles.facultyName}>{application.programName}</div>
                  </td>
                  <td className={styles.nameCell}>
                    <div className={styles.facultyName}>{application.facultyName}</div>
                  </td>
