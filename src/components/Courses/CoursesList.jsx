...
const CoursesList = ({ currentFaculty }) => {
  ...
  const [isAddAndUpdateCourseModalOpen, setIsAddAndUpdateCourseModalOpen] = useState(false);
              ...
              {sortedCourses.map((course) => (
                ...
                >
                  ...
                  <td className={!course.hoursCM ? styles.notAssigned : ""}>
                    {course.hoursCM === null || course.hoursCM === undefined ? "Not set" : course.hoursCM}
                  </td>
                  <td className={!course.hoursTD ? styles.notAssigned : ""}>
                    {course.hoursTD === null || course.hoursTD === undefined ? "Not set" : course.hoursTD}
                  </td>
                  <td className={!course.hoursTP ? styles.notAssigned : ""}>
                    {course.hoursTP === null || course.hoursTP === undefined ? "Not set" : course.hoursTP}
                  </td>
